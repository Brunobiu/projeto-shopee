...
@Entity
@Table(name = "endereco")
@SequenceGenerator(name = "seg_endereco", sequenceName = "seg_endereco", allocationSize = 1, initialValue = 1)
public class Endereco implements Serializable{


	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seg_endereco")
	private Long id;
